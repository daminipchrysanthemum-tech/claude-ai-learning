...
├── CLAUDE.md                      # Auto-generated by Claude Code — project context and standards
├── tools/
│   ├── document.py                # document_path_to_markdown tool implementation
│   └── math.py                    # add tool implementation (reference standard)
├── tests/
│   ├── test_document.py           # 8 tests for document tools (3 existing + 5 new)
│   └── fixtures/
│       ├── mcp_docs.docx          # Test fixture — DOCX file
│       └── mcp_docs.pdf           # Test fixture — PDF file
├── .trees/
│   └── feature_a/                 # Git worktree for parallel development
├── screenshots/
│   ├── Claude_Code_In_Action__Part_1_.png
│   ├── Claude_Code_In_Action__Part_2_.png
│   ├── Claude_Code_In_Action__Part_3_.png
│   ├── Claude_Code_In_Action__Part_4_.png
│   ├── Claude_Code_In_Action__Part_5_.png
│   ├── Enhancements_with_MCP_Servers.png
│   └── Parallelizing_Claude_Code.png
└── README.md
...
- Claude Code goes beyond autocomplete — it reads your codebase, understands your standards, and enforces them across new code
- Running /init with context-specific instructions produces a CLAUDE.md that makes every future Claude Code session project-aware
- Prompting Claude Code to plan tests before writing code produces more thorough coverage than writing tests after the fact
- Git worktrees allow Claude Code to work on multiple features in parallel on separate branches without environment conflicts
- Connecting Claude Code to an MCP server extends what it can do — it can call your own tools mid-task to verify real output
